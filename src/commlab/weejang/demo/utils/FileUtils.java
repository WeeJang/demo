...
public class FileUtils
{
	 ...
	 * @throws IOException
	 */
	public static File createSDFile(String dirname, String filename)
			throws IOException
	{
	 ...
	 * 流操作
	 */
	public static void write2SDFromInput(OutputStream outputStream,
